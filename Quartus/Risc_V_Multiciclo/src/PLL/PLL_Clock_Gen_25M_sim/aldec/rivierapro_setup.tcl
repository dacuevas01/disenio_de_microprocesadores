...
# ACDS 20.1 720 win32 2024.04.03.19:08:27
# ----------------------------------------
...
# ----------------------------------------
# If PLL_Clock_Gen_25M is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLL_Clock_Gen_25M"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_Clock_Gen_25M.vo"
}
